...
open("ntut-portal-ocr-login.user.js", "w", encoding="utf-8").write(out)
print(f"built ntut-portal-ocr-login.user.js  ({len(out)/1024:.0f} KB), version {version}, dtype {man.get('dtype')}")
